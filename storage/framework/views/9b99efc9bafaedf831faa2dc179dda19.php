    ...
    <div class= "bg-groc">
        <div class="container flex items-center justify-between px-4 py-4 mx-auto">
            ...
            <div class="text-xl text-white">
                <!--[if BLOCK]><![endif]--><?php if(auth()->check() && auth()->id() == $post->user_id): ?>
                    <a href="<?php echo e(route('project.edit', [$user, $post])); ?>" class="flex items-center ml-4 text-white">
    ...
    <div class="bg-white">
        <div class="container mx-auto ">
            <!--[if BLOCK]><![endif]--><?php if(session('message')): ?>
                <div class="p-4 text-green-800 bg-green-100 border border-green-600 rounded">
                    ...
                    <div class="pl-4">
                        <div class="mb-4">
                            <button type="button" title="Like post"
                                ...
                                <?php if(auth()->check()): ?> wire:click="toggleLike()" <?php endif; ?>>
...
<?php endif; ?>
                        ...
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <div>
                            <a class="text-gray-400 a2a_dd" href="https://www.addtoany.com/share">
                                ...
                                <div class="py-4">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $post->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(\Storage::url($document->path)); ?>" target="_blank"
                                            class="flex items-center p-2 py-2 mb-2 text-sm text-gray-600 border border-gray-500 rounded hover:bg-gray-200 bg-gray-50">
                                            <div class="pr-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                    class="size-5">
...
<?php endif; ?></div>Compartir
                        ...
                        <div id="comments" class="pt-8">
                            <div>
                                <!--[if BLOCK]><![endif]--><?php if($this->showComments): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-199018623-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-199018623-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-199018623-2', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /Users/marc/Code/scratch/resources/views/livewire/post-page.blade.php ENDPATH**/ ?>