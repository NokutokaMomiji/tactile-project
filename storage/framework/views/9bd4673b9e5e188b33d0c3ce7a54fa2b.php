  <div>
      <div class="mb-2">
          <h2 class="text-base font-semibold leading-7 text-gray-900"><?php echo e(__('Imatges')); ?></h2>
      </div>
      <div>
          <label for="file" class="flex justify-center h-24" x-data="drop_file_component()">
            ...
            "
                  ...
                  <div class="text-center" wire:loading.remove wire.target="files"><?php echo e(__('Fes clic o arrossega fitxers per pujar')); ?></div>
                  <div class="mt-1" wire:loading.flex wire.target="files">
                      ...
                      <div><?php echo e(__('Pujant imatges...')); ?></div>Ele                  </div>
              </div>
          </label>
      ...
      <div>
          <!--[if BLOCK]><![endif]--><?php if(count($projectFiles)): ?>
              <ul class="relative grid grid-cols-4 gap-4" wire:sortable="updateImagesOrder">
                  <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $projectFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <li wire:sortable.item="<?php echo e($image['id'] ?? 0); ?>" wire:key="image-<?php echo e($image['id'] ?? 0); ?>"
...
<?php /**PATH /hosting/www/tactilejr.org/projects/resources/views/partials/file-uploader.blade.php ENDPATH**/ ?>