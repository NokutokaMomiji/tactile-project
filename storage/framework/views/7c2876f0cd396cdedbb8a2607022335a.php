...
$__html = app('livewire')->mount($__name, $__params, 'HXVEOBU', $__slots ?? [], get_defined_vars());
                ...
                <ul role="list" class="divide-y" x-data="{ openCollections: false }">
                    ...
                    <li>
                        ...
                        <ul x-show="openCollections">
                            <!-- __BLOCK__ --><?php $__currentLoopData = auth()->user()->collections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $collection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="text-xs">
                                    <button type="button" wire:click='toggleCollection(<?php echo e($collection->id); ?>)'
                                        ...
                                        <!-- __BLOCK__ --><?php if(!! $collection->posts()->where('post_id', $post->id)->count()): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'ddvTqUU', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /var/www/vhosts/piscastudio.com/scratch.piscastudio.com/resources/views/livewire/post-page.blade.php ENDPATH**/ ?>