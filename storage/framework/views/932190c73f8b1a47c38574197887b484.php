<div x-data="{ showCommentForm: true }">
    <div class="flex justify-between">
        <h4 class="font-bold"><?php echo e(__('Comentaris')); ?></h4>
        
    </div>
    <!--[if BLOCK]><![endif]--><?php if(!$this->message && auth()->check()): ?>
    <!--[if BLOCK]><![endif]--><?php if(!$this->message): ?>
        <div x-show="showCommentForm" class="mb-8" x-transition>
            <textarea class="h-24 w-full" wire:model="body" placeholder="<?php echo e(__('Introdueix el teu comentari a aqui...')); ?>" rows="8"
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'publish']); ?><?php echo e(__('PUBLICAR COMENTARI')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-on:click' => 'showCommentForm = ! showCommentForm']); ?><?php echo e(__('CANCELAR')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                        ...
                        <div class="relative flex items-start space-x-3">
                            ...
                            <div class="flex-1 min-w-0 p-4 border border-gray-200 rounded-md bg-gray-50">
                                <div>
                                    ...
                                    <p class="mt-0.5 text-xs text-gray-500"><?php echo e(__('Ha comentat')); ?>
...
<?php /**PATH /hosting/www/tactilejr.org/projects/resources/views/livewire/comments.blade.php ENDPATH**/ ?>