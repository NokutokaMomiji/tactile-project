...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-600"><?php echo e(__("Recorda'm")); ?></span>
            </label>
        </div>

        <div class="mt-4 text-left">
            <p class="text-sm text-gray-600">
                <?php echo e(__('Si encara no tens usuari,')); ?>

                <a href="<?php echo e(route('age-gate')); ?>" class="text-indigo-600 hover:text-indigo-500">
                    <?php echo e(__('registra\'t ara')); ?>
...
<?php endif; ?>
<?php /**PATH /hosting/www/tactilejr.org/projects/resources/views/auth/login.blade.php ENDPATH**/ ?>