...
$__html = app('livewire')->mount($__name, $__params, '7C5YSFk', $__slots ?? [], get_defined_vars());
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                                 <?php $__env->slot('trigger', null, []); ?> 
                                    <button
                                        ...
                                        <div>
                                            <img class="w-8 h-8 rounded-full" src="<?php echo e(auth()->user()->featured_image); ?>"
                                                alt="">
                                        </div>
                                 ...
                                 <?php $__env->slot('content', null, []); ?> 
                                    ...
                                    <?php if(Auth::user()): ?>
                                        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => '/'.e(Auth::user()->username).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => '/'.e(Auth::user()->username).'']); ?>
...
<?php endif; ?>
                            <?php else: ?>
                            	<a href="<?php echo e(route('register')); ?>"
                                        class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out text-white border border-transparent rounded-md   focus:outline-none">
                                        Register
                                    </a>
...
<?php /**PATH /var/www/vhosts/piscastudio.com/scratch.piscastudio.com/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>