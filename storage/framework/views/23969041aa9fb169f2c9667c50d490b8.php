...
<div class="bg-blau">
    ...
    <p class="text-custom text-white ml-2 cursor-pointer block hover:underline" id="translation-text" onclick="toggleTranslation()">
        <span class="block"><?php echo e(__('traduir')); ?></span>
        <span class="block"><?php echo e(__('contingut')); ?></span>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3922604957-0', $__slots ?? [], get_defined_vars());
...
?>
                    ...
                    <?php else: ?>
                        <div class="flex ml-4 space-x-4 text-white items-center h-full"> <!-- Añadido h-full -->
                            <a href="/login" class="hover:underline h-full flex items-center" style="text-wrap:nowrap"><?php echo e(__('Iniciar sessió')); ?></a>
                            <a href="<?php echo e(route('age-gate')); ?>" class="hover:underline h-full flex items-center" style="text-wrap:nowrap"><?php echo e(__("Registra't")); ?></a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3922604957-1', $__slots ?? [], get_defined_vars());
...
?>
    ...
    <p class="text-custom text-white ml-2 cursor-pointer block hover:underline" id="translation-text" onclick="toggleTranslation()">
        <span class="block"><?php echo e(__('Traduir contingut automàticament')); ?></span>
    </p>
</div>
                    <?php if(auth()->check()): ?>
                    ...
                    <?php else: ?>
                           ...
                           <a href="<?php echo e(route('age-gate')); ?>" class="flex items-center h-full px-3 text-base text-white transition duration-300 text-center hover:bg-blue-400 hover:underline hover:text-lg" style="text-wrap:nowrap"><?php echo e(__("Registra't")); ?></a>
...
</style><?php /**PATH /hosting/www/tactilejr.org/projects/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>