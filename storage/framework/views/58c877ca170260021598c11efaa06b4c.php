  <div>
      <div class="mb-2">
          <h2 class="text-base font-semibold leading-7 text-gray-900">Imatges</h2>
      </div>
      <div>
          <label for="file" class="flex justify-center h-24" x-data="drop_file_component()">
            ...
            "
                  ...
                  <div class="text-center" wire:loading.remove wire.target="files">Fes clic o arrossega fitxers per
                      pujar</div>
...
<?php /**PATH /Users/marc/Code/scratch/resources/views/partials/file-uploader.blade.php ENDPATH**/ ?>