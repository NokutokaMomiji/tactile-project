    ...
    <div class="relative mx-auto">
        <div class="relative">
            ...
            <input type="text" placeholder="Buscar..." wire:model.live='s'
                class="px-4 py-1.5 bg-blue-300 w-full rounded-full text-white h-11 mx-2.5 placeholder:text-white plceholder: placeholder:text-xl" />
...
<?php /**PATH /Users/orioltriguero/code/scratch/resources/views/livewire/search-form.blade.php ENDPATH**/ ?>