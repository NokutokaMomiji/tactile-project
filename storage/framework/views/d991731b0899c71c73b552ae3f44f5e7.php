        ...
        <div class="w-full" x-show="showDropdown" x-on:click.away="showDropdown = false">
            <div class="absolute w-full mt-2 text-sm text-left bg-white border border-gray-300 rounded shadow">
                <ul class="w-full pb-2 space-y-2 overflow-y-auto scroll-pb-2 scroll-pt-11" id="options"
                    role="listbox">
                    <!--[if BLOCK]><![endif]--><?php if($this->projects && $this->users->count()): ?>
                        <li>
                            <h2 class="bg-gray-100 px-4 py-2.5 text-xs font-semibold text-gray-900">Usuaris</h2>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($this->projects && $this->projects->count()): ?>
                        <li>
                            <h2 class="bg-gray-100 px-4 py-2.5 text-xs font-semibold text-gray-900">Projectes</h2>
                            <ul class="text-sm text-gray-800">
                ...
                <!--[if BLOCK]><![endif]--><?php if($this->s && !count($this->projects) && !count($this->users)): ?>
                    ...
                    <div class="px-6 text-sm text-center border-t border-gray-100 py-14 sm:px-14">
                        ...
                        <p class="mt-4 font-semibold text-gray-900">No s'han trobat resultats</p>
                        <p class="mt-2 text-gray-500">No hem trobat res amb aquest terme. Si us plau, torneu-ho a
                            provar.</p>
                    </div>
            </div>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php /**PATH /Users/marc/Code/scratch/resources/views/livewire/search-form.blade.php ENDPATH**/ ?>