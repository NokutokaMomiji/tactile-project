...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($this->showModal): ?>
            ...
            <div class="fixed inset-0 z-10 w-screen p-4 overflow-y-auto sm:p-6 md:p-20">
                ...
                <div x-on:click.away="open = false"
                    ...
                    <ul class="p-3 overflow-y-auto max-h-96 scroll-py-3" id="options" role="listbox">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->relations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /hosting/www/tactilejr.org/projects/resources/views/livewire/sidebar-user.blade.php ENDPATH**/ ?>